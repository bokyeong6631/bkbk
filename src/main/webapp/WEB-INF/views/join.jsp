...
$(document).ready(function() {
		...
		$("#checkId").click(function() {
			...
			if(loginId == ""){
				...
				if(loginId.length >= 6){
				 //아이디 중복검사 실행
				 var url = "${_ctx}/check/id.java6?loginId="+loginId;
    ...
    <div id="join">
        ...
        <form id="frmJoin" action="${_ctx}/join.java6" name="frmJoin">
        	...
        	<dl>
                ...
                <dd><input type="text" id="phoneN" name="phone" alt="mobile" maxlength="13" placeholder="핸드폰" style="width:70%;" required="required"/>
