package kr.co.bkbk.common.file;
...
@Service
public class PopupFileService {
	static final Logger logger = LoggerFactory.getLogger(PopupFileService.class);
	 ...
	 * @return
	 */
	public PopupFileDTO uploadSingleFile(MultipartFile multipartFile, HttpSession httpSession){
		...
		if(multipartFile != null 
			...
			logger.debug("멀ㄹ티 ======>"+multipartFile.getContentType());
			
			//파일 사이즈;;;;;;;;;
			fileInfo.setFileSize((int) limitFileSize);
	...
	public void downloadFile(HttpServletResponse response, HttpSession httpSession, PopupFileDTO fileDTO) {
