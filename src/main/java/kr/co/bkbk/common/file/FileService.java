...
public class FileService {
	...
	//팝업이미지파일 업로드
	public PopupFileDTO uploadSingleImg(MultipartFile multipartFile, HttpSession httpSession){
...
//						fileInfo.setErrorCode(9);
	...
	public BoardFileDTO uploadSingleFile(MultipartFile multipartFile, HttpSession httpSession){
		...
		if(multipartFile != null 
			...
			//파일 사이즈;;;;;;;;;
			fileInfo.setFileSize(limitFileSize);
	...
	public void downloadExcelFile(HttpServletResponse response, HttpSession httpSession, XSSFWorkbook workBook) {
