...
<div id="rightWrap">
	...
	<div class="rightBlock">
		...
		<div class="boardWrap">
			<form id="frmWrite" action="${_ctx}/board/doc/photo/write.java6" method="post" enctype="multipart/form-data">
			...
			<table class="base_tbl tbl_write">
				<tbody>
					<tr>
						...
						<td><input type="text" name="title" placeholder="제목입력" required="required"/></td>
					</tr>
					<tr>
			...
			<div class="btnSet alignCenter">
				...
				<a href="${_ctx}/board/doc/photo/list.java6?mapId=${mapId}" class="disPB btnBase" >취소</a>
			</div>
		</div>
	</div>
	</div>
